...
exports.bookinstance_create_post = [
    ...
    // Validate fields. 
    validator.body('book', 'Book must be specidied').isLength({ min: 1 }).trim(),
    validator.body('imprint', 'Imprint must be specidied').isLength({ min: 1 }).trim(),
    validator.body('due_back', 'Invalid').optional({ checkFalsy: true }).isISO8601(),

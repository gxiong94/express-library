...
exports.author_detail = function(req, res, next) {
  ...
  async.parallel({
    // find author by id (the id on url)
    author: function(callback) {
      Author.findById(req.params.id)
        .exec(callback)
    },
    // find by author associated Book instances
...
exports.author_create_post = [
  ...
  validator.sanitizeBody('death_of_birth').toDate(),
  validator.sanitizeBody('death_of_death').toDate(),
